...
export default function About() {
  return (
    <div className="flex w-full flex-col items-center justify-center py-8  bg-white text-black ">
      ...
      <div className="flex flex-col py-8 space-y-5 ml-4 mr-4">
        ...
        <div className="text-xl md:text-lg lg:text-xl text-blue-500">Blue</div>
