...
export default function About() {
  return (
    <div className="min-h-screen text-black bg-aboutMe bg-cover flex flex-col items-center justify-center mx-auto text-center lg:flex-3">
      <div className="font-semibold   text-5xl  bg-opacity-95 shawdow  bg-white m-2 p-2 rounded-md mt-20">
        About Me
      </div>
      <ShuffleCards />
      <div className="flex flex-col justify-center items-center w-11/12 md:w-4/5">
        ...
        <div className="font-bold ">
          <div className="font-semibold border  border-gray-200 bg-white p-4 text-xl space-y-2 rounded-md shadow-lg hover:scale-105 hover:shadow-md transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 w-11/12 md:w-4/5 mx-auto mb-8 ">
            <div className="flex flex-col font-semibold bg-white  border border-gray-200 p-4 mt-2 text-base md:text-2xl lg:text-xl rounded-md shadow-lg hover:scale-105 hover:shadow-md transition-all  text-center items-center">
