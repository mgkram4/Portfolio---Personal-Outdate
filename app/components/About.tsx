  ...
  return (
    <div className=" min-h-screen flex flex-col items-center justify-center mx-auto text-center lg:flex-3">
      <div className="flex flex-col justify-center items-center w-11/12 md:w-4/5">
        ...
        <div className="font-semibold bg-slate-50 p-4 w-11/12 md:w-4/5 text-sm md:text-base lg:text-lg rounded-md shadow-lg hover:scale-105 hover:shadow-md transition-all">
          <div className="mb-4">
        ...
        <div className="flex font-semibold mt-8 text-lg md:text-xl lg:text-2xl m-2">
          Accomplishments
        </div>
